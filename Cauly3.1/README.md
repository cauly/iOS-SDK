...
5.	SDK 구성
	- cauly SDK v3.1.0
		- 헤더 파일
			...
			- CaulyNativeAd.h – Native 광고 클래스 헤더
...
3. Cauly.h, CaulyAdView.h, CaulyInterstitialAd.h, CaulyNativeAd.h 파일을 import 한다. 
...
4. 광고View를 생성 한다. [자세한 내용 CaulySample project 참조]
    ...
    - iOS 7.1 이하 버전의 디바이스에서 Banner 광고의 Orientation Rotate 를 정확히 처리하기 위해선 아래 code를 적용. iOS 8 이상에서는 불필요.
      ```objectivec    
...
#### cauly SDK 설치 관련하여 문의 사항은 고객센터 1544-8867 또는 cauly@futurestream.co.kr 로 문의 주시면 빠르게 응대해 드리도록 하겠습니다
